...
class Testproj_data(unittest.TestCase):
    def test_2dvec_quadratic(self):
        ...
        plot_data = proj_data(vectorized_2d, x_vals,
                              theta_names, vectorized=True)
    ...
    def test_2dnonvec_quadratic(self):
        ...
        x_vals = proj_xvals(theta, theta_lims, n_pts)
        plot_data = proj_data(nonvectorized_2d, x_vals,
                              theta_names, vectorized=False)
    ...
    def test_1d_quadratic(self):
        ...
        x_vals = proj_xvals(theta, theta_lims, n_pts)
        plot_data = proj_data(quadratic_1d, x_vals,
                              theta_names, vectorized=False)
